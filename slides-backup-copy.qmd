...
![](images/tableau.png){.absolute top=50 left=50}

. . .

![](images/pbi.png){.absolute top=150 right=100}

. . .

![](images/looker.png){.absolute bottom=150 right=150}
...
::: {.fragment}
Example provided on Storytelling with Data, by Cole Nussbaumer Knaflic.
:::
