...
:::{.notes}
So this storytelling principle is one of the simplest but one of the hardest.
...
[click]
Streamlit: Customized/experimental presentations. 
Nevertheless, I still follow the data storytelling principles. It's just the software that it changes. Overall, my talks are always kind of my babies. I spent too much time on them, crafting the details, learning how to push the software a bit beyond. I think people can notice when you put love into something. 
:::
...
:::{.notes}
My favorite book on data storytelling is Storyworthy, by Storytelling with Data, by Cole Nussbaumer. It very well written, and it explains step by step why some visualizations work and others fail.
:::
