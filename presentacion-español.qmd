...
## { .custom-title }
::: {style="position: absolute; left: 300px; top: 10px; background-color: #69b1e9; opacity: 50%; padding: 20px; border-radius: 5px;"}
[Evitemos más "muertes por PowerPoint"]{style="font-size: 30px; line-height: 1em; margin: 0px; opacity: 200% !important;"} <br>
...
##  
::: columns
::: {.column width="65%" .fragment  fragment-index=2}
